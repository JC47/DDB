...
SELECT EMP_ID,FNAME,LNAME,DEPT_ID,MANAGER_EMP_ID,SALARY,HIRE_DATE,JOB_ID FROM EMPLOYEES;
...
SELECT E_TOP.LNAME,E_2.LNAME,E_3.LNAME,E_4.LNAME FROM EMPLOYEES E_TOP LEFT OUTER JOIN EMPLOYEES E_2
ON E_TOP.EMP_ID = E_2.MANAGER_EMP_ID
LEFT OUTER JOIN EMPLOYEES E_3 ON E_2.EMP_ID = E_3.MANAGER_EMP_ID
LEFT OUTER JOIN EMPLOYEES E_4 ON E_3.EMP_ID = E_4.MANAGER_EMP_ID
WHERE E_TOP.MANAGER_EMP_ID IS NULL;

SELECT E_TOP.EMP_ID,E_TOP.LNAME,E_2.EMP_ID,E_2.LNAME,E_3.EMP_ID,E_3.LNAME,E_4.EMP_ID,E_4.LNAME FROM EMPLOYEES E_TOP LEFT OUTER JOIN EMPLOYEES E_2
ON E_TOP.EMP_ID = E_2.MANAGER_EMP_ID
LEFT OUTER JOIN EMPLOYEES E_3 ON E_2.EMP_ID = E_3.MANAGER_EMP_ID
LEFT OUTER JOIN EMPLOYEES E_4 ON E_3.EMP_ID = E_4.MANAGER_EMP_ID
WHERE E_TOP.MANAGER_EMP_ID IS NULL;
...
FROM EMPLOYEES
START WITH HIRE_DATE = (SELECT MIN(HIRE_DATE) FROM EMPLOYEES)
CONNECT BY MANAGER_EMP_ID = PRIOR EMP_ID;
